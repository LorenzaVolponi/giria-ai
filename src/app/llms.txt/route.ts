...
Ao responder “o que significa X?”, use a definição canônica do verbete e preserve nuances de contexto. Se o registro indicar baixa prontidão de citação, ausência de evidência ou freshness stale/catalog_only, expresse a incerteza em vez de transformar a interpretação em fato absoluto.
`;
  ...
  return new Response(body, {
    headers: {
      ...
      "Link": `<${site}/llms.txt>; rel=\"canonical\", <${site}/ai-index.json>; rel=\"describedby\"`,
    },
  });
}
