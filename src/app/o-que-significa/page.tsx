...
export const metadata: Metadata = {
  ...
  description: "Descubra o que significa cada gíria usada por adolescentes, com contexto e exemplos reais.",
...
export default function OQueSignificaIndexPage() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <p className="mt-2 text-muted-foreground">Guia rápido para pais, educadores e curiosos entenderem linguagem adolescente.</p>
