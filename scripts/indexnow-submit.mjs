...
if (allCore) add(
  ...
  "/editorial-index.json", "/ai-index.json", "/authority.json", "/answers.json", "/knowledge.json", "/distribution.json",
...
if (matches((file) => file.startsWith("src/app/o-que-significa/"))) add("/o-que-significa", "/answers.json", "/knowledge.json", "/ai-index.json");
...
if (matches((file) => file.startsWith("src/app/llms.txt/") || file === "public/llms.txt")) add("/llms.txt", "/ai-index.json", "/answers.json", "/authority.json");
...
if (matches((file) => file === "src/lib/editorial-evidence.ts")) {
  add(
    "/editorial-index.json", "/authority.json", "/answers.json", "/knowledge.json", "/distribution.json", "/ai-index.json", "/o-que-significa",
    "/o-que-significa/farmar%20aura", "/answer/farmar%20aura", "/o-que-significa/six%20seven", "/answer/six%20seven",
    "/o-que-significa/delulu", "/answer/delulu", "/o-que-significa/brainrot", "/answer/brainrot",
  );
}
...
if (matches((file) => /^src\/lib\/slang-(data|extra|regional|real|generated)/.test(file))) add("/o-que-significa", "/girias", "/girias/regionais", "/observatorio", "/authority.json", "/answers.json", "/knowledge.json", "/distribution.json", "/api/graph", "/ai-index.json");
